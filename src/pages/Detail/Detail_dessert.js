...
const Detail = (props) => {
	return (
		<div>
			<Dj_Details_header />
			<Dj_Slider2 argt='dessertid' url='http://120.55.70.81:8088/dajiaserver/Rest/Shop/get_dessert_info' />		
		  	<Dj_Details argt='dessertid' url='http://120.55.70.81:8088/dajiaserver/Rest/Shop/get_dessert_info' />
		  	<WhiteSpace size='xs' />
		  	<Dj_Details3 />
		  	<WhiteSpace size='xs' />
		  	<Dj_Details_Tabs />
