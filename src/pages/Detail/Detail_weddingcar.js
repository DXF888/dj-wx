...
const Detail = (props) => {
	...
	return (
		<div>
			<Dj_Details_header />
			<Dj_Slider2 argt='weddingcarid' url='http://120.55.70.81:8088/dajiaserver/Rest/shop/get_wedding_car_info' />		
		  	<Dj_Details argt='weddingcarid' url='http://120.55.70.81:8088/dajiaserver/Rest/shop/get_wedding_car_info' />
		  	<WhiteSpace size='xs' />
		  	<Dj_Details3 argt='weddingcarid' url='http://120.55.70.81:8088/dajiaserver/Rest/shop/get_wedding_car_info' />
		  	<WhiteSpace size='xs' />
		  	<Dj_Details_Tabs />
		  	<Dj_Details_footer />
		</div>
