...
//	console.log(props);
const {weddingphotographyid, address, name, collection, price,evaluate,visit, applistimg,packagecount} = props;
  return (
    <Link to={`/weddingphotography/${weddingphotographyid}`} className="mall_item">
