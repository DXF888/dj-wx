...
function regularDinner(value,index){
	...
	var Id1 = getval.slice(1,2).join();
	let taocan_value;
	var value = value;
//	console.log(value);
	if(value.weddingppackageid !== undefined){
//		console.log(11);
		taocan_value = value.weddingppackageid;
//		console.log(taocan_value);
	}else if(value.weddingcpackageid !== undefined){
//		console.log(12);
		taocan_value = value.weddingcpackageid;
	}else if(value.dessertid !== undefined){
//		console.log(13);
		taocan_value = value.dessertid;
	}else if(value.weddingdpackageid !== undefined){
//		console.log(14);
		taocan_value = value.weddingdpackageid;
	}else if(value.weddingcarpackageid !== undefined){
//		console.log(15);
		taocan_value = value.weddingcarpackageid;
	}
	return (
