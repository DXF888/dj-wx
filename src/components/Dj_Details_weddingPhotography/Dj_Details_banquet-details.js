...
function taoc_xq(data2){
	...
	if(Id3 == 'weddingphotography'){
			...
			return (
				<div>
				<h3>{data2.EmceePackageInfo.packagename}</h3>
				<p className='info'>{data2.EmceePackageInfo.info}</p>
					<table>
						<tbody>
							<tr>
								<td>司仪姓名:</td>
								<td >{data2.EmceePackageInfo.emceename}</td>
								<td>出生地:</td>
								<td >{data2.EmceePackageInfo.address}</td>
								<td>出生年月:</td>
								<td >{data2.EmceePackageInfo.brithday}</td>
							</tr>
							<tr>
								<td>风格:</td>
								<td >{data2.EmceePackageInfo.style}</td>
								<td>才艺:</td>
								<td>{data2.EmceePackageInfo.perform}</td>
							</tr>
							<tr>
								<td>团队构成:</td>
								<td colSpan='8'>{data2.EmceePackageInfo.teamformation}</td>
							</tr>
						</tbody>
					</table>
			</div>
...
class Banquet_details extends React.Component {
	...
	componentDidMount() {
		if(this.Id1 == 'weddingphotography'){
			this.url = 'http://120.55.70.81:8088/dajiaserver/Rest/shop/get_wedding_p_package_info';
			this.argt = 'weddingppackageid';
		}else if(this.Id1 == 'dress'){
			this.url = 'http://120.55.70.81:8088/dajiaserver/Rest/shop/get_wedding_d_package_info';
			this.argt = 'weddingdpackageid';
		}else if(this.Id1 == 'company'){
			this.url = 'http://120.55.70.81:8088/dajiaserver/Rest/shop/get_wedding_c_package_info';
			this.argt = 'weddingcpackageid';
		}else if(this.Id1 == 'dessert'){
			this.url = 'http://120.55.70.81:8088/dajiaserver/Rest/Shop/get_dessert_package_info';
			this.argt = 'packageid';
		}else if(this.Id1 == 'car'){
			this.url = 'http://120.55.70.81:8088/dajiaserver/Rest/shop/get_wedding_car_package_info';
			this.argt = 'weddingcarpackageid';
		}else if(this.Id1 == 'emcee'){
			...
			this.url = 'http://120.55.70.81:8088/dajiaserver/Rest/shop/get_camera_package_info';
			this.argt = 'camerapackageid';
		}else if(this.Id1 == 'actor'){
			this.url = 'http://120.55.70.81:8088/dajiaserver/Rest/shop/get_actor_package_info';
			this.argt = 'actorpackageid';
		}
