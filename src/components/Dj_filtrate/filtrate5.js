...
//	console.log('isClick:'+this.newData.isClick);
  ...
  render() {
    return (
    	<div className='filtrate4 filtrate5'>
	      ...
	      <div className='filtrate'>
	      	<div className="filter-area fl" onClick={this.handleClick.bind(this,'婚礼区域')}>
						<a id='area' href="javascript:;">筛选区域</a>
					</div>
